...
class _AddressState extends State<Address> {
  ...
  String m_state_placeholder = "Select State";
  String m_city = "City";
  String m_city_placeholder = "Select City";
  String m_postal_code = "Postal Code";
  String m_postal_code_placeholder = "Your Postal Code";
  String m_address = "Address";
  String m_address_placeholder = "Your Address";
  bool m_City_show = false;
  bool m_Zone_show = false;
  ...
  onAddressAdd(context) async {
    ...
    var zone_name = _zoneController.text.toString();
    ...
    var addressAddResponse = await AddressRepository().getAddressAddResponse(
        ...
        city_id: _selected_city == null ? 0 : _selected_city.id,
  ...
  onSelectCountryDuringAdd(country, setModalState) {
    if (country.id == 69) {
      m_address = "City";
      m_address_placeholder = "Enter your city";
      m_postal_code = "Woreda/ ወረዳ";
      m_postal_code_placeholder = "Your Woreda Code";
      m_state = "Region";
      m_state_placeholder = "Select Region";
      m_city = "Zone";
      m_city_placeholder = "Enter Zone";
    } else {
      m_address = "Address";
      m_address_placeholder = "Enter your address";
      m_postal_code = "Postal code";
      m_postal_code_placeholder = "Your Postal Code";
      m_state = "State";
      m_state_placeholder = "Select State";
      m_city = "City";
      m_city_placeholder = "Select City";
    }
    // if (country.id == 231) {
  ...
  onSelectStateDuringAdd(state, setModalState) {
    if (state.id == 1119) {
      m_city = "Sub-City";
      m_city_placeholder = "Enter Sub-City";
    } else {
      if (_selected_country.id == 231) {
        m_city = "City";
        m_city_placeholder = "Enter your city";
      } else {
        m_city = "Zone";
        m_city_placeholder = "Enter Zone";
      }
    ...
    if (_selected_country.id == 69 && state.id != 1119) {
      m_Zone_show = true;
      m_City_show = false;
    } else {
      m_Zone_show = false;
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: TextField(
                            ...
                            autofocus: false,
                            decoration: InputDecoration(
                                hintText: m_postal_code_placeholder,
                                hintStyle: TextStyle(
                                    fontSize: 12.0,
                                    color: MyTheme.textfield_grey),
                                enabledBorder: OutlineInputBorder(
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: TextField(
                            ...
                            decoration: InputDecoration(
                                hintText: m_address_placeholder,
                                hintStyle: TextStyle(
                                    fontSize: 12.0,
                                    color: MyTheme.textfield_grey),
                                enabledBorder: OutlineInputBorder(
